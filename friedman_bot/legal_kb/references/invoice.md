...
всего, утрачен. Если это подтвердится — счета 2026 года должны выставляться с
19 % USt, а не по §19. Прежде чем массово выставлять/переставлять счета 2026,
финальную квалификацию подтвердить со Steuerberater. Бот — не Steuerberater:
