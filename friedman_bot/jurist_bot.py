...
async def on_file(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    instruction = (
        ...
        "Это может быть договор (Vertrag), счёт (Rechnung), письмо из ведомства (Finanzamt/KSK/"
        "Krankenkasse/Jobcenter) или иной официальный документ. Дай налогово-правовую оценку: "
